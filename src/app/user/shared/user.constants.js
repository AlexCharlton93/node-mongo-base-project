export const userErrorMessages = {
	body: 'Please submit a valid request',
	id: 'Unable to find details based on data provided',
	email: 'Please enter a valid email address',
	emailAddressPassword: 'Please enter a valid email address and password',
